                ...
                <table class="order-products-head table table-striped">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>Mesa:</th>
                            <td class="id-mesa" id="id-mesa" colspan="2"># {{ $order->table_id}}</td>
                        </tr>
                        <tr>
                            <th>Cliente: </th>
                            <td class="customer-id" id="customer-id" colspan="3">
                                {{ $order->c_first_name }} {{ $order->c_last_name }}
                            </td>
                        </tr>
                        <tr>
                            <th>Nombre</th>
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <form method="post" action="{{ url('/caja/store') }}">
                                    ...
                                    <input hidden type="number" name="table_id" id="table_id" value="{{isset($order->table_id)?$order->table_id: old('table_id')}}">
