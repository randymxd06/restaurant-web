...
@section('content_header')
    <h1>Agregar Tipo de Reservación</h1>
...
@section('content')
    ...
    <!-- FORMULARIO -->
    <form method="post" action="{{ url('type-reservation/store') }}">
        ...
        <div class="col-md-6 mb-2">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Escribe el nombre del tipo de reservación"/>
                </div>
            </div>
        </div>
        <!-- / -->
