        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 card-login">
            <x-jet-authentication-card>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mt-4">
                        <x-jet-label for="email" value="{{ __('Correo Electroónico') }}" />
